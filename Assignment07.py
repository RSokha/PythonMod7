...
#   <RSokha>,<11/30/2023>,<Classes and Objects>
# ------------------------------------------------------------------------------------------ #
import json
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        RSokha,1.1.2030,Created function
...
class IO:
    ...
    ChangeLog: (Who, When, What)
    RSokha,1.1.2030,Created Class
    RSokha,1.2.2030,Added menu output and input functions
    RSokha,1.3.2030,Added a function to display the data
    RSokha,1.4.2030,Added a function to display custom error messages
    """
    ...
    def output_error_messages(message: str, error: Exception = None):
        ...
        ChangeLog: (Who, When, What)
        RSokha,1.3.2030,Created function
